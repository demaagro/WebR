...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebRTC processing");
    
    let mut processor = WebRTCProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebRTCProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebRTCProcessor::new(false);
